package com.walking.tbooking.constant;
...
public class ContextAttributeNames {
    ...
    public static final String FLIGHT_CONVERTER = "flightConverter";
    ...
    public static final String AIRPORT_DTO_CONVERTER = "airportDtoConverter";
    ...
    public static final String FLIGHT_DTO_CONVERTER = "flightDtoConverter";
